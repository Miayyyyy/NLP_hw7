...
def test_decoderlayer(target, create_look_ahead_mask):
    def g():
        ...
        padding_mask = None
        out, attn_w_b1, attn_w_b2 = decoderLayerq(q, encoderq_output, training=True,
...
def test_decoder(target, create_look_ahead_mask, create_padding_mask):
    def g():
        ...
        decoderk = target(num_layers=num_layers,
                          embedding_dim=embedding_dim,
                          num_heads=num_heads,
                          fully_connected_dim=fully_connected_dim,
                          target_vocab_size=target_vocab_size,
                          maximum_position_encoding=maximum_position_encoding)
        outd, att_weights = decoderk(x, encoderq_output, training=False, look_ahead_mask=look_ahead_mask,
                                     padding_mask=None)
        ...
        outd, att_weights = decoderk(x, encoderq_output, training=True, look_ahead_mask=look_ahead_mask,
                                     padding_mask=None)
...
def test_transformer(target, create_look_ahead_mask, create_padding_mask):
    def g():
        ...
        summary_example_1 = [0.02845942, 0.03648348, 0.02448654, 0.02044249, 0.0313297, 0.03174436, 0.01480646,
                             0.03073534]
        ...
        summary_example_2 = [0.02847256, 0.03805957, 0.0252011, 0.02128581, 0.03038325, 0.03146167, 0.01493196,
                             0.03245409]
